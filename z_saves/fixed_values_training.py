...
# RL network, no inputs just values, 23 inputs and 20 outputs. made to create base model.
# what we wanna do but with log_prob
...
for step in range(50000):
    ...
    if step % 100 == 0:
        ...
        print(f"head y: {vals[20]:.4f} reward: {reward.item():.4f}")
